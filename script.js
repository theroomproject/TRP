...
const roomTypes = [
  ...
  {name:'Spiritual / Prayer Room',emoji:'🕊️',cat:'wellness',price:'RM4,000–RM15,000+',img:'serene_modern_islamic_prayer_room.webp',tone:'soft',desc:'A respectful, peaceful room designed around the customer’s faith practices, storage needs and preferred religious décor.',features:['Customer-selected religious décor','Prayer / reflection area','Calm lighting','Purposeful storage','Soft flooring options','Peaceful colour palette']},
  {name:'Zen / Meditation Room',emoji:'🧘',cat:'wellness',price:'RM4,000–RM15,000+',img:'serene_zen_tea_room_retreat.webp',tone:'soft',desc:'A low-clutter wellness space that uses natural material cues, warm lighting and calm zoning to help the room feel quieter.',features:['Minimalist layout','Plants & natural textures','Floor seating','Diffusers','Warm indirect lighting','Hidden storage']},
  {name:'Mini Cinema Room',emoji:'🎬',cat:'entertainment',price:'RM12,000–RM45,000+',img:'cinematic_home_theater_with_paramount_screen.webp',tone:'warm',desc:'A compact private cinema with controlled light, comfortable seating and an AV setup planned around the room.',features:['Projector or large display','Blackout treatment','Speaker setup','Cinema seating','Mood lighting','Acoustic improvements']},
  {name:'Music Room',emoji:'🎧',cat:'entertainment',price:'RM10,000–RM40,000+',img:'moody_orange_lit_creator_studio.webp',tone:'warm',desc:'A creative listening or playing environment combining instrument display, storage, audio and acoustic treatment.',features:['Instrument display','Speaker positioning','Acoustic panels','Record / media shelving','Ambient lighting','Cable and equipment storage']},
  {name:'Podcast / Streaming Room',emoji:'🎙️',cat:'work',price:'RM8,000–RM25,000+',img:'moody_orange_lit_creator_studio.webp',tone:'vivid',desc:'A camera-ready workspace for podcasting, live streaming and video production with practical acoustic and lighting design.',features:['Microphone zone','Camera positioning','Backdrop design','Acoustic treatment','Key / fill lighting','Desk & equipment storage']},
  {name:'Home Office Transformation',emoji:'💻',cat:'work',price:'RM6,000–RM22,000+',img:'moody_charcoal_home_office_with_amber_glow.webp',tone:'cool',desc:'A focused, ergonomic workspace that looks professional on calls and works harder for storage and productivity.',features:['Ergonomic desk layout','Office chair planning','Professional backdrop','Task lighting','Storage systems','Cable management']},
  {name:'Study Room',emoji:'📚',cat:'work',price:'RM5,000–RM18,000+',img:'cozy_fantasy_children_s_bedroom_workspace.webp',tone:'soft',desc:'A distraction-reduced learning room built around good task lighting, books, organisation and comfortable desk work.',features:['Study desk','Bookshelves','Task lighting','Whiteboard / planning zone','Organisation systems','Comfortable reading area']},
  {name:'Nature / Jungle Room',emoji:'🌿',cat:'lifestyle',price:'RM6,000–RM20,000+',img:'sunlit_bohemian_jungle_conservatory.webp',tone:'vivid',desc:'A lush botanical room using greenery, wood, earthy materials and natural-feeling light for an indoor escape.',features:['Greenery walls / plants','Wood textures','Earth-tone palette','Natural lighting effects','Botanical décor','Organic soft furnishings']},
  {name:'Luxury Hotel Room',emoji:'✨',cat:'premium',price:'RM12,000–RM35,000+',img:'tropical_eco_luxe_bedroom_retreat.webp',tone:'soft',desc:'A polished bedroom inspired by boutique hotels: layered lighting, premium bedding, tailored curtains and elegant details.',features:['Statement headboard wall','Premium bedding','Bedside lighting','Full-length mirrors','Tailored curtains','Hotel-style accessories']},
  {name:'Dark Luxury Room',emoji:'🖤',cat:'premium',price:'RM12,000–RM35,000+',img:'moody_luxury_bedroom_with_orange_accents.webp',tone:'warm',desc:'A dramatic, sophisticated bedroom using charcoal tones, metallic accents, atmospheric light and statement furniture.',features:['Black / charcoal palette','Gold / metallic accents','Atmospheric lighting','Statement artwork','Premium furniture','Layered textures']},
...
projectForm.addEventListener('submit',e=>{e.preventDefault();const chosen=roomTypes.find(r=>r.name===formRoom.value);const brief=`TRP — THE ROOM PROJECT\nFREE QUOTATION ENQUIRY / CUSTOMER PROJECT BRIEF\n\nRoom concept: ${formRoom.value}\nIndicative website range: ${chosen ? convertPriceRange(chosen.price)+' '+activeCurrency : 'To be assessed'}\nLocation: ${document.getElementById('formLocation').value}\nRoom size: ${document.getElementById('formSize').value}\nWorking budget: ${document.getElementById('formBudget').value}\nDesired scope: ${document.getElementById('formScope').value}\n\nCustomer vision / must-haves:\n${document.getElementById('formVision').value || 'Not provided yet'}\n\nIMPORTANT: This is an initial project brief, not a quotation. Final scope and pricing require TRP assessment and confirmation from the relevant specialist partners and suppliers.`;briefOutput.textContent=brief;briefWrap.hidden=false;const whatsappUrl='https://wa.me/60102380016?text='+encodeURIComponent('Hi TRP, I would like a FREE quotation. Here is my completed project brief:\n\n'+brief);const opened=window.open(whatsappUrl,'_blank','noopener');if(!opened){window.location.href=whatsappUrl;}briefWrap.scrollIntoView({behavior:'smooth',block:'center'})});
